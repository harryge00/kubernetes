...
const (
	fcPluginName = "kubernetes.io/fc_dhc"
)
...
func (plugin *fcPlugin) GetVolumeName(spec *volume.Spec) (string, error) {
	...
	return fmt.Sprintf("%v", volumeSource.VolumeID), nil
}
...
func getVolumeSource(spec *volume.Spec) (*v1.FCDHCVolumeSource, bool, error) {
	if spec.Volume != nil && spec.Volume.FCDHC != nil {
		return spec.Volume.FCDHC, spec.Volume.FCDHC.ReadOnly, nil
	} else if spec.PersistentVolume != nil &&
		spec.PersistentVolume.Spec.FCDHC != nil {
		return spec.PersistentVolume.Spec.FCDHC, spec.ReadOnly, nil
	}
