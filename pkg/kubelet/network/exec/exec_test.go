...
func TestPluginStatusHook(t *testing.T) {
	...
	plug, _, err := network.InitNetworkPlugin(ProbeNetworkPlugins(testPluginPath), pluginName, "", nettest.NewFakeHost(nil), componentconfig.HairpinNone, "10.0.0.0/8", network.UseDefaultMTU)
