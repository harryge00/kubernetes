			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						...
						"sampleWindow": {
							SchemaProps: spec.SchemaProps{
								Description: "sampleWindow set the number of workload for each container to retain in memory",
								Type:        []string{"integer"},
								Format:      "int32",
							},
						},
