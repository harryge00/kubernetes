...
func (m *JobSpec) MarshalTo(data []byte) (int, error) {
	...
	i += n8
	if m.ActiveDeadlineCount != nil {
		data[i] = 0x38
		i++
		i = encodeVarintGenerated(data, i, uint64(*m.ActiveDeadlineCount))
	}
	if m.FailedDeleteAll != nil {
		data[i] = 0x40
		i++
		if *m.FailedDeleteAll {
			data[i] = 1
		} else {
			data[i] = 0
		}
...
func (m *JobSpec) Size() (n int) {
	...
	n += 1 + l + sovGenerated(uint64(l))
	if m.ActiveDeadlineCount != nil {
		n += 1 + sovGenerated(uint64(*m.ActiveDeadlineCount))
	}
	if m.FailedDeleteAll != nil {
		n += 2
	}
...
func (this *JobSpec) String() string {
	...
	s := strings.Join([]string{`&JobSpec{`,
		...
		`ActiveDeadlineCount:` + valueToStringGenerated(this.ActiveDeadlineCount) + `,`,
		`FailedDeleteAll:` + valueToStringGenerated(this.FailedDeleteAll) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *JobSpec) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ActiveDeadlineCount", wireType)
			}
			var v int32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ActiveDeadlineCount = &v
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FailedDeleteAll", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorGenerated = []byte{
	...
	,
}
