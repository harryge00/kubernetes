...
func (s *KubeletServer) AddFlags(fs *pflag.FlagSet) {
	...
	fs.Int32Var(&s.SampleWindow, "sample-window", s.SampleWindow, "The sample-window value for number of appliaction workload record in memory for each container. Values must be within the range [-1000, 1000]")
