...
func TestAdmission(t *testing.T) {
	...
	if pod.Spec.Volumes[0].HostPath.Path != "/var/log/containers/123_test_ctr1_javalog" {
		t.Errorf("Expected hostpath /var/log/containers/123_test_ctr1_javalog, got %s", pod.Spec.Volumes[0].HostPath.Path)
	}
	if pod.Spec.Volumes[1].HostPath.Path != "/var/log/containers/123_test_ctr2_journal" {
		t.Errorf("Expected hostpath /var/log/containers/123_test_ctr2_journal, got %s", pod.Spec.Volumes[1].HostPath.Path)
	}
